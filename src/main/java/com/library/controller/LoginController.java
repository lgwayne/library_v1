...
public class LoginController {
    ...
    public String AdminMain(HttpServletResponse response) {
        return "forward:/WEB-INF/jsp/admin_main.jsp";
    }
    /**
     * 读者登录跳转
     * @param response
     * @return
     */
    @RequestMapping(value = "/reader_admin", method = RequestMethod.GET)
    public String ReaderMain(HttpServletResponse response) {
        return "forward:/WEB-INF/jsp/reader_main.jsp";
    }
