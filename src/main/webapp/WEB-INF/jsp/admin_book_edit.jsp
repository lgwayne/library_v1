        ...
        <div class="panel-body">
            <form action="book_edit_do.html?bookId=${detail.bookId}" method="post" id="addbook" >
                ...
                <div class="input-group">
                    ...
                    <input type="date" class="form-control" name="pubstr" id="pubstr" value="<fmt:formatDate value="${detail.pubdate}" dateStyle="medium" pattern="yyyy-MM-dd" />">
                </div>
                <div class="input-group">
                    <span  class="input-group-addon">分类</span>
                    <%--<input type="text" class="form-control" name="classId" id="classId" value="${detail.classInfo.class_name}">--%>
                    <div class="col-sm-10">
                        <select class="form-control" name="classId">
                            <option selected="selected">${detail.classInfo.class_name}</option>
