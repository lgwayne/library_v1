...
CREATE TABLE `book_info` (
  ...
  PRIMARY KEY (`book_id`),
  KEY `class_related` (`class_id`),
  CONSTRAINT `class_related` FOREIGN KEY (`class_id`) REFERENCES `class_info` (`class_id`) ON UPDATE RESTRICT
...
INSERT INTO `book_info` VALUES ('15', '神探夏洛克', '柯南道尔', '广东广电书出版社·', '20190009900909', '22', '英汉', '200.00', '2019-12-26', '9', '2');
INSERT INTO `book_info` VALUES ('17', '测试用书2', '我写的', '人民日报出版社', '2020202020', '一本好书吧', '中文', '30.00', '2019-12-20', '18', '20');
INSERT INTO `book_info` VALUES ('19', '测试用书3', '马冬梅', '人民日报出版社', '202020202020', '一本好书', '中文', '10.00', '2019-12-28', '20', '20');
INSERT INTO `book_info` VALUES ('20', '大雪中的山庄', '东野圭吾 ', '北京十月文艺出版社', '9787530216835', '东野圭吾长篇小说杰作，中文简体首次出版。 一出没有剧本的舞台剧，为什么能让七个演员赌上全部人生.东野圭吾就是有这样过人的本领，能从充满悬念的案子写出荡气回肠的情感，在极其周密曲折的同时写出人性的黑暗与美丽。 一家与外界隔绝的民宿里，七个演员被要求住满四天，接受导演的考验，但不断有人失踪。难道这并非正常排练，而是有人布下陷阱要杀他们。 那时候我开始喜欢上戏剧和音乐，《大雪中的山庄》一书的灵感就来源于此。我相信这次的诡计肯定会让人大吃一惊。——东野圭吾', '中文', '35.00', '2017-06-07', '9', '2');
INSERT INTO `book_info` VALUES ('24', 'admin', '柯南道尔', '广东广电书出版社', '20190009900909', '啊啊啊', '中文', '26.80', '2019-12-27', '9', '3');
...
CREATE TABLE `lend_list` (
  ...
  PRIMARY KEY (`ser_num`),
  KEY `book_related` (`book_id`),
  KEY `reader_related` (`reader_id`),
  CONSTRAINT `book_related` FOREIGN KEY (`book_id`) REFERENCES `book_info` (`book_id`),
  CONSTRAINT `reader_related` FOREIGN KEY (`reader_id`) REFERENCES `reader_card` (`reader_id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of lend_list
-- ----------------------------
INSERT INTO `lend_list` VALUES ('3', '3', '10003', '2019-06-12', '2019-09-02');
INSERT INTO `lend_list` VALUES ('4', '4', '10000', '2019-03-15', '2019-09-03');
INSERT INTO `lend_list` VALUES ('5', '5', '10002', '2019-06-15', null);
INSERT INTO `lend_list` VALUES ('6', '6', '10000', '2019-06-15', null);
INSERT INTO `lend_list` VALUES ('9', '17', '10000', '2019-12-06', '2019-12-06');
INSERT INTO `lend_list` VALUES ('14', '3', '10000', '2019-12-10', '2019-12-11');
INSERT INTO `lend_list` VALUES ('16', '20', '10000', '2019-12-11', '2019-12-11');
INSERT INTO `lend_list` VALUES ('17', '4', '10000', '2019-12-11', '2019-12-11');
INSERT INTO `lend_list` VALUES ('18', '3', '10000', '2019-12-15', '2019-12-15');
INSERT INTO `lend_list` VALUES ('20', '3', '10000', '2019-12-17', '2019-12-17');
INSERT INTO `lend_list` VALUES ('21', '5', '10000', '2019-12-17', '2019-12-17');
...
CREATE TABLE `reader_card` (
  ...
  CONSTRAINT `reader_` FOREIGN KEY (`reader_id`) REFERENCES `reader_info` (`reader_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `reader_card` VALUES ('10009', 'admin', '1111');
...
-- ----------------------------
INSERT INTO `reader_info` VALUES ('10000', '张华', '男', '1995-06-16', '广东省广州市', '12345678900');
...
INSERT INTO `reader_info` VALUES ('10009', 'admin', '男', '2019-12-11', '广东省广州市', '15511111111');
